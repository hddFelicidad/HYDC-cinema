...
public class RefundStrategyForm {
     ...
     * 适用电影列表
     */
    private List<Integer> movieFormList;
    ...
    public List<Integer> getMovieFormList(){return movieFormList;}

    public void setMovieFormList(List movieFormList){this.movieFormList=movieFormList;}

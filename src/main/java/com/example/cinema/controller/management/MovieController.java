...
public class MovieController {
    ...
    @RequestMapping(value = "/movie/refund",method = RequestMethod.GET)
    public ResponseVO getMovieWithoutRefundStrategy(){
        return movieService.getMovieWithoutRefundStrategy();
    }

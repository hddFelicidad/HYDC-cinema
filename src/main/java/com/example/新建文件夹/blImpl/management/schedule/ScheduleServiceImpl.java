...
public class ScheduleServiceImpl implements ScheduleService, ScheduleServiceForBl {
    ...
    @Override
    public List<ScheduleItem> selectScheduleByMovieIdAndDate(int movieId,Date date,Date afterDate){
        return scheduleMapper.selectScheduleByMovieIdAndDate(movieId,date,afterDate);
    }
